...
(def fixture
  [{:id :bootstrap-load-isolation :suite :runner :description "bootstrap lazy Malli load isolation" :entrypoint 'hegel.suites.runner/bootstrap-load-isolation}
   ...
   {:id :concurrent-api-declarations :suite :stateful :description "concurrent API declarations and pure validation" :entrypoint 'hegel.suites.stateful/concurrent-api-declarations}
